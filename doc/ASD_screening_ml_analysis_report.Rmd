...
```{r plot 1, echo=FALSE, fig.cap="Figure 1. Confusion Matrix between the true ASD Diagnoses and the result of the ASD-10 results"}
...
The following programming were used for this project: Python[@Python] and R[@R]. The following R packages were used: tidyverse[@tidyverse],knitr[@knitr], reshape2[@reshape2], docopt[@docopt], and caret[@Kuhn09thecaret]. The following Python packages were used:docopt[@docoptpython], zipfile, pandas, urllib, requests, sklearn, numpy, scipy, and altair.


## Analysis

The following programming languages were used for this project: Python[@Python] and R[@R]. The following R packages were used: tidyverse[@tidyverse],knitr[@knitr], and reshape2. The following Python packages were used: docopt, zipfile, pandas, urllib, requests, sklearn, numpy, scipy. GridSearchCV was used to optimize parameters (maybe use the markdown variables to report any hyperparameters)

To start, we explored the correlational relationships between the different AQ-10 survey questions.

```{r plot 4, echo=FALSE, fig.cap="Figure 2. Correlation heatmap of between questions on the ASD_10"}
...
```{r plot 5, echo=FALSE, fig.cap="Figure 3. Proportion of true diagnosis and their final score on the ASD-10"}
